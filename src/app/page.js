...
export default function Home() {
  return (
    <>
      <div className="container mx-auto ">
        <div className="pb-16">
          <div className="w-1/3 py-16">
            <h1 className="text-MainColor text-6xl">
              Dirise-<span className="text-black">Branding</span>
            </h1>
            <h6 className="text-black text-2xl text-center my-2 tracking-widest">
              Live Better
            </h6>
          </div>
          <div>
            <p className="text-center text-[#20262C] text-xl tracking-widest">
        ...
        <div className="text-center items-center pb-10">
          <h1 className="text-MainColor tracking-normal text-3xl">
            Dirise<span className="text-black ">Subscription</span>{" "}
          </h1>
          <p className="text-center text-Seconday tracking-widest w-1/2 mx-auto mt-10">
            Lorem Ipsum is simply dummy text of the printing and typesetting
          ...
          <Link href="/about">
            <h1 className="mt-10 text-MainColor font-medium">
              Subscribe Now!{" "}
            </h1>
          </Link>
        </div>
        ...
        <div className="pb-10">
          <h1 className="text-[#000A28] text-center text-2xl font-medium">
            ...
            <span className="text-MainColor"> Dirise ?</span>{" "}
          </h1>
        ...
        <div className="text-center items-center mb-10">
          <h1 className="text-[#000A28] text-center text-2xl font-medium">
            Sounds like a <span className="text-MainColor"> plan ! </span>{" "}
          </h1>
      ...
      <div className="bg-[#024e70]  p-10 mb-10">
        <div className="text-[#F5F5F5] text-center container mx-auto w-1/3">
          <h1 className="font-medium text-3xl">
            Try Our<span className="text-MainColor"> Ai</span> Generator
          </h1>
      ...
      <div className="text-center items-center mb-10">
        <h1 className="text-[#000A28] text-center text-2xl font-medium">
          Why <span className="text-MainColor"> Dirise</span> is the No.1 choice
          for business{" "}
        </h1>
        <p className="text-center text-Seconday tracking-widest w-4/5  mx-auto mt-10">
          Lorem Ipsum is simply dummy text of the printing and typesetting
          industry. Lorem Ipsu m Ipsum has been the industry's Lorem Ipsum is
          simply dummy text of the printing and typesetting industry. Lorem Ipsu
          m Ipsum has been the industry's Lorem Ipsum is simply dummy text of
          the printing and typesetting industry. Lorem Ipsu m Ipsum has been the
          industry's Lorem Ipsum is simply dummy text of the printing and
          typesetting industry. Lorem Ipsu m Ipsum has been the industry's{" "}
        </p>
        <Link href="/about">
